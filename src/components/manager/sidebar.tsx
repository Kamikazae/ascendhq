...
const navItems = [
  { 
    ...
    description: "Team overview & insights",
    color: "text-blue-600",
    bgColor: "bg-blue-50",
...
export function Sidebar({ role, userName = "Manager", userEmail = "" }: SidebarProps) {
            ...
            return (
              <div key={href}>
                ...
                >
                  {/* Active indicator */}
                  {isActive && (
                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-green-500 to-blue-500 rounded-r" />
                  )}
        ...
        {!isCollapsed && (
          <div className="mt-8 p-4 bg-gradient-to-br from-green-50 to-blue-50 rounded-xl border border-green-100">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-medium text-green-900">Team Stats</span>
            </div>
