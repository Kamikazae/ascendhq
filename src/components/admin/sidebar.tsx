...
const navItems = [
  { 
    ...
    description: "System overview & insights",
    color: "text-blue-600",
    bgColor: "bg-blue-50",
  ...
  { 
    ...
    icon: UserCog,
    description: "Oversee team leaders",
  ...
  { 
    ...
    href: "/admin/manage-objectives", 
    icon: Target,
    description: "Oversee all objectives",
...
export function Sidebar({ role, userName = "Administrator", userEmail = "", className }: SidebarProps) {
          ...
          <div className="mb-8 p-4 bg-white rounded-xl border border-gray-100 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <Badge variant="default" className="mt-1 text-xs bg-purple-100 text-purple-800">
        ...
        {!isCollapsed && (
          <div className="mt-8 p-4 bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl border border-purple-100">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-medium text-purple-900">System Stats</span>
            </div>
